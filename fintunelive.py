...
def finetune_model():
    ...
    srocc_l = []
    plcc_l = []
    data_dir = os.path.join('D:/dataset/IQA/LIVEIQA_release2/')
    images = pd.read_csv(os.path.join(data_dir, 'mos_nor.csv'), sep=',')

    images_fold = "D:/dataset/IQA/LIVEIQA_release2/"
...
def load_data(mod = 'train'):
    ...
    transformed_dataset_train = ImageRatingsDataset(csv_file=train_path,
                                                    root_dir='D:/dataset/IQA/LIVEIQA_release2/',
