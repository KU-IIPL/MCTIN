...
def finetune_model():
    ...
    srocc_l = []
    plcc_l = []
    data_dir = os.path.join('D:/dataset/IQA/CSIQ/')
    images = pd.read_csv(os.path.join(data_dir, 'csiq_test_mos.csv'), sep=',')

    images_fold = "D:/dataset/IQA/CSIQ/"
...
def load_data(mod = 'train'):
    ...
    transformed_dataset_train = ImageRatingsDataset(csv_file=train_path,
                                                    root_dir='D:/dataset/IQA/CSIQ/all_dist_imgs/',
