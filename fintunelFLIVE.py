...
def finetune_model():
    ...
    srocc_l = []
    plcc_l = []
    data_dir = os.path.join('D:/dataset/IQA/FLIVE/')
    images = pd.read_csv(os.path.join(data_dir, 'Normalized_MOS_Data.csv'), sep=',')

    images_fold = "D:/dataset/IQA/FLIVE/"
