...
def finetune_model():
    ...
    srocc_l = []
    plcc_l = []
    data_dir = os.path.join('D:/dataset/IQA/CID2013/')
    images = pd.read_csv(os.path.join(data_dir, 'CID2013_mos_normalization.csv'), sep=',')

    images_fold = "D:/dataset/IQA/CID2013/"
...
def load_data(mod = 'train'):
    ...
    transformed_dataset_train = ImageRatingsDataset(csv_file=train_path,
                                                    root_dir='D:/dataset/IQA/CID2013/total_image',
